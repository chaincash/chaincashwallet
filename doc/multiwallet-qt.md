...
In order to support loading of multiple wallets in chaincash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chaincash.cpp.
...
Changes to chaincash.cpp
----------------------
chaincash.cpp is the entry point into chaincash-qt, and as such, will require some minor modifications to provide hooks for
