...
This mechanism has been integrated into Bitcore-Node-Chaincash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Chaincash-Project/insight-api-chaincash#web-socket-api](https://github.com/Chaincash-Project/insight-api-chaincash#web-socket-api) 
* API: [https://github.com/Chaincash-Project/insight-api-chaincash#swifttx-transactions](https://github.com/Chaincash-Project/insight-api-chaincash#swifttx-transactions) 
...
By default, the Chaincash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Chaincash Core daemon:
