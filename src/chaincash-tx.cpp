...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Chaincash Core chaincash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  chaincash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chaincash transaction") + "\n" +
                               "  chaincash-tx [options] -create [commands]   " + _("Create hex-encoded chaincash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chaincash transaction
