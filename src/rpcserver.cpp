...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Chaincash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Chaincash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Chaincash features */
        {"chaincash", "masternode", &masternode, true, true, false},
        {"chaincash", "listmasternodes", &listmasternodes, true, true, false},
        {"chaincash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"chaincash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"chaincash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"chaincash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"chaincash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"chaincash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"chaincash", "masternodedebug", &masternodedebug, true, true, false},
        {"chaincash", "startmasternode", &startmasternode, true, true, false},
        {"chaincash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"chaincash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"chaincash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"chaincash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"chaincash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"chaincash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"chaincash", "mnbudget", &mnbudget, true, true, false},
        {"chaincash", "preparebudget", &preparebudget, true, true, false},
        {"chaincash", "submitbudget", &submitbudget, true, true, false},
        {"chaincash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"chaincash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"chaincash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"chaincash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"chaincash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"chaincash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"chaincash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"chaincash", "checkbudgets", &checkbudgets, true, true, false},
        {"chaincash", "mnsync", &mnsync, true, true, false},
        {"chaincash", "spork", &spork, true, true, false},
        {"chaincash", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcchseed", &getzcchseed, false, false, true},
        {"zerocoin", "setzcchseed", &setzcchseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcch", &searchdzcch, false, false, true},
        {"zerocoin", "dzcchstate", &dzcchstate, false, false, true}
...
{
    return "> chaincash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5673/\n";
}
