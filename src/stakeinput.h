...
#ifndef Chaincash_STAKEINPUT_H
#define Chaincash_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZCCH() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zCCHStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zcch, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZCCH() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZCCH() override { return false; }
};


#endif //Chaincash_STAKEINPUT_H
