                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Chaincash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Chaincash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chaincash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCCH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Chaincash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Chaincash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Chaincash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Chaincash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Chaincash addresses"));
    ...
    openAction->setStatusTip(tr("Open a Chaincash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Chaincash Core help message to get a list with possible Chaincash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Chaincash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Chaincash network", "", count));
}
...
{
    QString strTitle = tr("Chaincash Core"); // default title
