...
/* Chaincash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Chaincash"
#define QAPP_ORG_DOMAIN "chaincash.org"
#define QAPP_APP_NAME_DEFAULT "Chaincash-Qt"
#define QAPP_APP_NAME_TESTNET "Chaincash-Qt-testnet"
