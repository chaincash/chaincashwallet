...
/** Utility functions used by the Chaincash Qt UI.
 */
namespace GUIUtil
{
...
// Render Chaincash addresses in monospace font
...
// Parse "chaincash:" URI into recipient object, return true on successful parsing
