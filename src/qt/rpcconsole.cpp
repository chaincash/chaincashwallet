                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCCHPathCustom = GetArg("-zcchbackuppath", "");
    ...
    if(!strzCCHPathCustom.empty()) {
        ui->wallet_customzcchbackuppath->setText(QString::fromStdString(strzCCHPathCustom));
        ui->wallet_customzcchbackuppath_label->setVisible(true);
        ui->wallet_customzcchbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCCHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Chaincash RPC console.") + "<br>" +
