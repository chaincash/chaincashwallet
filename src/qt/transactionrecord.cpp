...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zcchTracker->HasMintTx(hash))) {
            //zCCH stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZCCH;
...
bool IsZCCHType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZCCH:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZCCH || type == TransactionRecord::MNReward) {
