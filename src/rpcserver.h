...
/**
 * Chaincash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcchseed(const UniValue& params, bool fHelp);
extern UniValue getzcchseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcch(const UniValue& params, bool fHelp);
extern UniValue dzcchstate(const UniValue& params, bool fHelp);
