Contributing to Chaincash Core
============================

The Chaincash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Chaincash Core project, and is not to be
confused with overall Chaincash Network Protocol consensus changes.

Whether a pull request is merged into Chaincash Core rests with the project merge
...
Patches that change Chaincash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Chaincash consensus, it must have been
...
The project leader is the release manager for each Chaincash Core release.
