...
#   c) node1 mines 32 blocks, so now node 0 has 60001cch, node 1 has 4250cch, node2 has none.
#   d) node0 sends 601 cch to node2, in two transactions (301 cch, then 300 cch).
